...
This repository contains public materials for the DM-FC01 control board. Only directories with real content are kept, and empty placeholder directories are removed.

## Contents

- [说明书/](说明书/) - Manuals, datasheets, and interface documents
- [固件/](固件/) - Firmware binaries and bootloader files
